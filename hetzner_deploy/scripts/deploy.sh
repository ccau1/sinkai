...
[ -n "$APP_IMAGE" ] || { echo "❌ APP_IMAGE is required (set in hetzner_deploy/.env or env)"; exit 1; }

COMPOSE_FILE="docker-compose.${ENV}.yml"
[ -f "$DEPLOY_DIR/$COMPOSE_FILE" ] || { echo "❌ $COMPOSE_FILE not found in hetzner_deploy/"; exit 1; }

...
export function PuckHero({
  ...
  return (
    <section
      ...
      style={{ minHeight, backgroundColor: 'var(--color-bg-inverted)' }}
    >
      ...
      <div className="container-main relative z-10 flex flex-col justify-center py-24" style={{ color: 'white' }}>
        <div className={`max-w-3xl ${alignmentClass}`}>
          ...
          {(primaryCtaLabel || secondaryCtaLabel) && (
            <div className="flex flex-wrap gap-4" style={{ justifyContent: align === 'left' ? 'flex-start' : align === 'right' ? 'flex-end' : 'center' }}>
              {primaryCtaLabel && (
